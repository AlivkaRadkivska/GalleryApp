...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"authentication.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"registration.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"deleting-user.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"updating-user.js":[function(require,module,exports) {
"use strict";
...
var _deletingUser = require("./deleting-user.js");
var _updatingUser = require("./updating-user.js");
//?DOM ELEMENTS
...
if (deleteBtn) deleteBtn.addEventListener('click', _deletingUser.deleteMe);
...
if (updateInfoForm) updateInfoForm.addEventListener('submit', function (e) {
  ...
  form.append('email', document.getElementById('email').value);
  if (document.getElementById('avatar').files[0]) form.append('avatar', document.getElementById('avatar').files[0]);
  (0, _updatingUser.updateMe)(form, 'info');
});
